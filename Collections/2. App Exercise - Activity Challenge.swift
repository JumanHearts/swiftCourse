 ...
 */
let walkingChallenges = ["Walk 3 miles a day", "Take 10,000 steps a day"]
let runningChallenges = ["Run 5 times a week", "Run a 10K race"]
...
// Check if the array is empty and print a message if it is
if userChallenges.isEmpty {
    print("Please commit to a challenge.")
}
// Check if the array contains exactly one element and print a message if it does
else if userChallenges.count == 1 {
    print("The challenge you have chosen is \(userChallenges[0]).")
}
// Otherwise, print a message indicating that the user has chosen multiple challenges
else {
