...
var name: String 
// print(name)
print("No, the code doesn't compile, because a variable 'name' used before being initialized")
...
print("No, the code doesn't compile, because swift cannot assign value of type 'Double' to type 'Int'")