...
>These exercises reinforce Swift concepts in the context of a fitness tracking app.
 ...
 Write an if-else statement below that will check that the entered user name and password match the stored user name and password. 
 While the password should be case sensitive, users should be able to log in even if their entered user name has the wrong capitalization. 
...
let searchName = "step"
let userNameLow = userName.lowercased()
if userNameLow.contains(searchName){
