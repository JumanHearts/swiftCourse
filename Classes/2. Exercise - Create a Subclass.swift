...
// Try to print the weapon on destroyer. This works because Fighter has a weapon property
...
// Call the fire() method on destroyer a few times and print remainingFirePower after each call
destroyer.fire()
